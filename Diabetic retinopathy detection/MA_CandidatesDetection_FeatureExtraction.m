...
parameters(1,:)=c;
imwrite('features.xls',tag,sheet,'A1')
imwrite('features.xls',parameters,sheet,'B1')
imwrite('features.xls',feat1,sheet,'B2')
...
imwrite('features.xls',predict,sheet,str)
rowNo = count+2;
...
sheet = 1;
imwrite('features.xls',feat2,sheet,str5)
